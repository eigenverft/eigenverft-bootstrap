...
namespace AxonInsight.Library.Controls
{
        ...
        public class TransparentLabelEx3 : Label
        {
            ...
            /// <summary>
            /// First color of the linear gradient for the text.
            /// </summary>
            ...
            /// <summary>
            /// Second color of the linear gradient for the text.
            /// </summary>
            [Category("AppearanceExtended")]
            ...
            /// <summary>
            /// Enables or disables a single directional text shadow.
            /// </summary>
            [Category("AppearanceExtended")]
            ...
            /// <summary>
            /// Color used for the single directional text shadow.
            /// </summary>
            [Category("AppearanceExtended")]
            ...
            /// <summary>
            /// Offset for the single directional text shadow.
            /// </summary>
            [Category("AppearanceExtended")]
            ...
            /// <summary>
            /// Enables or disables a full eight-directional text shadow.
            /// </summary>
            [Category("AppearanceExtended")]
            [Description("Enables or disables a full eight-directional text shadow.")]
            public bool FullShadowEnabled
            {
                get => fullShadowEnabled;
                set { fullShadowEnabled = value; Invalidate(); }
            }

            /// <summary>
            /// Color used for the full eight-directional text shadow (supports alpha).
            /// </summary>
            [Category("AppearanceExtended")]
            ...
            /// <summary>
            /// Distance in pixels for each direction in the full shadow.
            /// </summary>
            [Category("AppearanceExtended")]
            ...
            /// <summary>
            /// Draws the text with optional shadows and a linear gradient.
            /// </summary>
            protected override void OnPaint(PaintEventArgs e)
            {
                ...
                {
                    using (var brush = new SolidBrush(FullShadowColor))
                    {
                        var dirs = new Point[]
                        {
                ...
                // gradient text
                using (var brush = new LinearGradientBrush(ClientRectangle, StartColor, EndColor, GradientAngle))
                {
